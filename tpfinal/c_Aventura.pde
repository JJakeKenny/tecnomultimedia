class Aventura {
  ...
  void reiniciaAventura() {
    ...
    //aca se debería reiniciar los valores y luego cuando llamo esté método poner el loop = true

    //Tambien debería construirse el juego acá, ya que no se hace setup, ver también el tema del audio que queda fuera,
    //Tengo que lograr hacer un especie de "setup();" pero desde la propia clase y sin hacer el setup,
    //Así que todo lo que haga el "setup()", los valores que se declaran y demás, deben poder hacerse desde este método
