...
void draw() {
  ...
  println("timer:" + timer + "-moverY:" + moverY + "-opacidadTextoInicio:"
    + opacidadTI + "-moverYT:" + moverYT + "-moverY:" + moverY + "-opacidadFinal:" + opacidadDF);

 //imagen de fondo
  image(fondo5, 0, 0, 600, 600);

//efecto bordes oscuros 
  pushStyle();
  tint(255, 100);
...
//efecto desaceleracion en el titulo
  if (moverYT <= 230 && timer <= 180) {
    moverYT = 230;
