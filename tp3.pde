...
Link al video: https://www.youtube.com/watch?v=suhm__1YTBk
*/
...
//Modificación de variables en relación al desplazamiento del mouse
void mouseDragged(){
 
  //efecto de "scroll" lateral
  tX = constrain(map(mouseX, 100, 300, 100, 500),-200,300);

  //efecto de "zoom out" al bajar la escala en relación al mouse
  s = constrain(map(mouseX, 200,500, 0.5, 1),0.5,1);
